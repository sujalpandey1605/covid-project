    ...
    <div className="flex items-center justify-center min-h-screen p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-violet-400">Welcome Back</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 glass-panel py-3 hover:bg-slate-800 transition-colors"
          >
        ...
        <p className="text-center mt-6 text-slate-400">
          Don't have an account? <Link to="/signup" className="text-primary-500 hover:text-primary-400 font-medium">Sign Up</Link>
        </p>
      </motion.div>
    </div>
  );
